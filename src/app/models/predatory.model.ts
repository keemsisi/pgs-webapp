export class PredatoryPublishers{

    
    public getPredatoryJournals() : String {
       return `1088 Email Press
        2425 Publishers
        The 5th Publisher
        ABC Journals
        A M Publishers
        ...
        The Global Journals
        Global Journals, Inc. (US) (new websiite: https://globaljournals.org/)
        ...
        Id Press / ID Design (note: one of their journals – OAMJMS – is indexed in DOAJ)
        IERI & PRESS
        IGM Publication
        ...
        GPH Journal (connected to EPH Journal)
        Green Publication
        Gupta Publications
        Healthcare Bulletin
